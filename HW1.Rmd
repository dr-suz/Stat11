...
If you are analyzing this data in RStudio, importing the data is a bit easier because all you need to do is run the following command in your R console:
```{r, eval=FALSE}
