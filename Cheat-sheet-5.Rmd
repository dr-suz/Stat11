...
$$T.S. = \frac{\text{<estimate>} - \text{<hypothesized parameter value>}}{SE(\text{<estimate>})} \quad\text{OR}\quad 
T.S. = \frac{\text{<estimate>} - \text{<hypothesized parameter value>}}{st.dev(\text{<estimate>})} .$$
