...
![](../Stat11/images/Q1_hist.png){height=1.2in}
...
\vspace{1cm}
**X.** The following box plots show the closing share prices for a sample of technology companies on the first trading days in August 2007 and in August 2002. 

![](../Stat11/images/Q1_boxplots.png){height=3in}
...
\vspace{1cm}
**X.** The residuals plot for a linear model is shown. Which is TRUE? XXXXXXXXXXX

![](../Stat11/images/Q1_residuals.png){height=1.5in}
...
\vspace{1cm}
**X.** Which of the following is NOT a goal of re-expressing data? XXXXXXXXXXXXXX

(a) Make the distribution of a variable more symmetric. 

(b) Make the form of a scatter plot more nearly linear. 

(c) Make the scatter in a scatter plot spread out evenly rather than following a fan shape. 
...
\vspace{1cm}
**X.** The box plots show prices of used cars (in thousands of dollars) advertised for sale at three different car dealers. 
...
![](../Stat11/images/Q1_table.png){height=3.5in}
...
**A: strong negative linear, association price increases, lbs sold decreases, provided association is actually linear (verify with plot)** 
...
**X.** Work through a problem to figure out how to use the z-table 
