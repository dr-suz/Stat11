---
title: "Project Homework 3 Solutions"
author: "STAT011-S23"
output:
...
If you are analyzing this data in Excel you first need to [download the arthritis data set for HW 3](https://github.com/dr-suz/Stat11/blob/main/Data/arthritis.csv) and [download the Titanic data set for HW 3](https://github.com/dr-suz/Stat11/blob/main/Data/titanic.csv) from our Stat 11 Github Data page. Do this by right clicking on the link "View Raw". Save each link with the names `arthritis.csv` and `titanic.csv`, respectively. 
...
**Notes to graders:** Answers should be counted as correct if they accurately describe the type of bias present (e.g. list the ways in which these sampling strategies could introduce bias) even if they don't refer to the explicit name of the bias listed above. 
...
(a) either $212/(673+212) = 0.240$ or $212/(673+212+122+203+167+118+528+178)=0.096$ are acceptable, question isn't specific enough to determine imo
...
**Notes to graders:** The answers to parts (a) - (c) must be correct for full credit. The answer for (d) is graded for a valid attempt at a solution. 
...
**Notes to graders:** The answers to (a) and (b) must be correct for full credit. Please give extra credit of 3 points to anyone who got (c) correctly.
