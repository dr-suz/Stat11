...
(b) We are 90\% sure that a child will say their first word when he is between 10.6 and 13.7 months old. 

(c) 90\% of the children in this sample said their first word when they were between 10.6 and 13.7 months old. 

(d) We are 90\% confident that the mean age at which children say their first word is between 10.6 and 13.7 months.
...
(d)  A larger sample should be used to achieve the stated margin of error. 
...
(a) We reject $H_0$, making a Type II error. 

(b) We reject $H_0$, making a Type I error.

(c) We correctly reject $H_0$.

(d) We fail to reject $H_0$, making a Type II error.
