...
Means, two sample independent, hypothesis test, experiment. $H_0: \mu_{name} - \mu_{noname} = 0 $ vs $H_A: \mu_{name} - \mu_{noname} > 0$.  
\vspace{1cm}
...
Proportions, two sample independent, confidence interval, observational study.  
\vspace{1cm}
...
Means, two sample paired, hypothesis test, observational study. $H_0: \mu_{pre} - \mu_{post} = 0$ vs $H_A: \mu_{pre} - \mu_{post} < 0$.  
\vspace{1cm}
...
Means, two sample independent, confidence interval, observational study. 
