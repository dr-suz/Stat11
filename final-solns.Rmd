...
**Skipped:** Q14, Q15, Q16, Q17, Q27, Q37, Q38,  Q41-43   


**better as MC question** 
...
\vspace{1cm}
**22.**  A manufacturing process has a $70\%$ yield, meaning that $70\%$ of the products are acceptable and $30\%$ are defective. If three of the products are randomly selected, $\rule{2cm}{0.15mm}$ is the probability that all three of them are acceptable.
...
**Solution:** $0.123$ - consider having student draw Venn diagram? 

\vspace{1cm}
**24.**  An education researcher was interested in examining the effect of the teaching method and the effect of the particular teacher on students' scores on a reading test. In a study, there are two different teachers (Juliana and Felix) and three different teaching methods (method A, method B, and method C). The number of students participating in the study is 258. Students are randomly assigned to a teaching method and teacher. What are the six different treatments? 
 
\vspace{1cm}
**25.** Based on the Normal model for yearly snowfall (in $cm$) in a certain town $N(57, 8)$, how many $cm$'s of snow would represent the 80th percentile approximately?  
...
Describe the story this plot tells about the closing share prices in these two years. Make sure your answer includes comparisons of variability, medians, and the shape of the distributions.

**Solution:** 

* Closing prices are more variable in $\rule{2cm}{0.15mm}$ than in the other year. 

* The median closing share price is higher in $\rule{2cm}{0.15mm}$ than in the other year. 

* The distribution of closing prices in $\rule{2cm}{0.15mm}$ appears more symmetric than the distribution of closing prices in the other year. 
...
\vspace{1cm}
**35.** Ten different families are tested for the number of gallons of water a day they use before and after viewing a conservation video. Given the summary statistics below, construct a $90\%$ confidence interval for the mean of the differences. 
...
\vspace{1cm}
**36.** Write a question that can be answered with a Chi-square test for homogeneity. 
