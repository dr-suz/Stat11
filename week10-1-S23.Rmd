...
![](./images/sec4dotplot.png){width=4in}


<!--![](./images/sec5dotplot.png){width=4in}-->

Out of our $xx$ samples, we observed $xx$ values for the sample proportion, $\hat{p}$. We didn't all observe the same number of green jelly beans, there was variability in the values of $\hat{p}$ among our samples. We call this the <span style="color:green">sampling variability of $\hat{p}$</span>. 

If we didn't know the true (population) proportion was $p=0.15$, we could have used this exercise to calculate $xx$ sample proportions to estimate the unknown model parameter, $p$.
...
Although we visualized these $xx$ different values of $\hat{p}$ with a dot plot, we could have also used a histogram. 

![](./images/sec4hist.png){width=4in}


<!--![](./images/sec5hist.png){width=4in}-->
