...
The <span style="color:green">standard error</span> of our estimate, $\widehat{p}$, is itself an estimate for the standard deviation of $\widehat{p}$. In symbols, we write 
$$SE(\widehat{p}) = \sqrt{\frac{\widehat{p}(1-\widehat{p})}{n}} = \sqrt{\frac{\widehat{p}\widehat{q}}{n}}.$$
...
$$\widehat{p} \pm [z^*_{a} \times SE(\widehat{p})],$$ 
