...
date: "9/21/21 (updated: `r Sys.Date()`)"
output:
...
.center[**Quick check:** Is your mask covering your nose and your mouth?]
...
* Homework policy 
  ...
  - No late homework is going to be accepted because solutions are released after the due date and your lowest HW grade is dropped. 
  
  - Knit your HW template the day of/after it is released. Any data or R issues should be identified by the next class!  
  
  - Read all instructions carefully! "Each answer must be supported by written statements". Show your work/explain your reasoning and be specific (use units when appropriate). Write so that my granddad can understand your answer! 

---
## Announcements 

* If you need to eat or drink during class, please step outside the classroom to do so. 

* For test 1 and 2, you will be able to submit corrections to missed problems for half credit. 

* Homework deadlines are extended until the end of the day (11:59pm). 
...
* Read chapter 11 and 12 (5th edition)

* Plan your preparation for test 1 
