...
```{r, eval=FALSE}
EnvoyAir_flights <- 
  read.csv("https://raw.githubusercontent.com/ProfSuzy/Stat11/main/Data/EnvoyAir_flights.txt")
```
...
Create a labeled bar/frequency chart for the variable `origin`. What story do these analyses tell about the variable `origin`? 
...
# Question with boxblots 
boxplots, histograms (compare info from each).
