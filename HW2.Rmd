...
d) The sample
e) The sampling method, including whether or not random selection and/or random assignment was employed
...
Analyze the design of each research 
...
factors, treatments, randomization, response variable, and any block-ing, matching, or blinding that may be present. In each, what kind of 
conclusions can be reached?


Review of Part I R1.15, R1.16, R1.40
Review of Part II R2.3, R2.4, R2.22, R2.44, R2.47
Review of Part III problems R3.19, R3.20

Idea: maybe make GHW 1 a bit simpler? 