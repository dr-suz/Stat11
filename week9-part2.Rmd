...
date: "11/4/21 (updated: `r Sys.Date()`)"
output:
...
* HW 6 is due tomorrow by 6:00pm.  

* Exam 2 is next Thursday, in class, same policies as for Exam 1. 

* Final project feedback will available by the end of the day tomorrow. 

Next class will be a review and we'll focus on a more general discussion about hypothesis tests and confidence intervals. 
