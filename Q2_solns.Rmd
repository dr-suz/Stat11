...
* ? - correct work for variance but incorrect answer
...
* 0.45 - defined a valid probability of success for p

* 0.45 - defined what follows the binomial distribution

* ? - incomplete definition of the variable that follows the binomial distribution

* 0.1 - defined number of trials/sample size
