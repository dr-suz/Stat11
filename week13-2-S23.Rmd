...
A technology committee wants to perform a test to see if the mean amount of time students are spending in the lab has increased from 55 minutes. They wish to determine if the school needs to increase lab fees to keep up with lab use. The sample of data recorded below are the lab times for $12$ students. 
...
## Two-tailed hypothesis test for paired means

Having done poorly on their Biology final exams in June, six students repeat the course in summer school and take another exam in August. Here are 
the exam scores:
