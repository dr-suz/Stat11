...
**Have students choose from any of the other previous data sets in GHWs and explore the data and answer 1 inference question. (meant to mirror the work they'll have to do for their final project if doing Option B). To be graded for completion.**
