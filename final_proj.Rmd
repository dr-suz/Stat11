...
Please submit your final project idea/topic to Prof Suzy's for approval by the **end of March**.

For projects (B) or (C), the type of data you use should involve at least one quantitative variable and one categorical variable. Typically people doing surveys will collect 5–8 variables on each subject. 
...
|        | Technical specifications | 0-1 | Is the poster SIZE? Was the topic approved on time? Was the poster printed on time? Is the font (except references) at least SIZE? Does the poster contain sections for Background, Methodology, Results, and Discussion? Does the poster include at least one relevant graphic?     |
...
You can be as creative as our practical constraints allow in designing your own experiment. The minimal requirements will be to ensure there is a treatment with at least two levels, and to strategically incorporate randomness in subject selection and/or treatment assignment. A few examples could be things like:
