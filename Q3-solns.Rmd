...
**11.** Based on the Z-table, the critical value for a $90\%$ confidence interval for the difference in proportions 

\vspace{1cm}

$p_1 - p_2$ is $\rule{2cm}{0.15mm}$.

$\pm 1.645$ acceptable answers include $1.64$ and $1.65$
...
full credit for $\sqrt{p(1-p)/n} = \sqrt{\frac{0.04(1-0.04)}{300}} = 0.01131$.

partial credit for $\frac{0.04(1-0.04)}{300} = 0.000128$.
...
$$T.S. = \frac{\frac{136}{400}-0.28}{\sqrt{\frac{0.28(1- 0.28)}{400}}}  = 2.673 \text{(full credit)}$$

$$T.S. = \frac{\frac{136}{400}-0.28}{\sqrt{\frac{\frac{136}{400}(1- \frac{136}{400})}{400}}}  = 2.533 \text{(partial credit)}$$
(Just plug the correct numbers into the correct formula, there is no need to simplify your answer.)
...
where $z^* = 2.325$. (give credit for using $2.32$ or $2.33$) give partial credit for $z^* = 2.55$ (corresponds to $94\%$ CI)
