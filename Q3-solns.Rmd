...
\vspace{1cm}
**8.**  Using the t-table, estimate the p-value for a test statistic that is less than or equal to $1.76$ with $24$ degrees of freedom. 
...
[insert t-curve with negative T.S.]
...
**1.18\%. to 5.76\%** [rework to use a conf level that is easy to read off the t-table]
...
**Conclude that participating in the workshop decreases employee anxiety**
