...
### 4) For any disjoint events in the sample space of a random variable, say, $A$ and $B$, we have:

$$Pr(A \text{ or } B) = Pr(A) + Pr(B)$$
**Generalized version of the addition rule:** For any events in the sample space, 
$$Pr(A \text{ or } B) = Pr(A) + Pr(B) - Pr(A \cap B)$$

### 5) If an event $A$ is independent of another event $B$, then:

$$Pr(A\cap B) = Pr(A)\times Pr(B).$$ 

**Generalized version of the multiplication rule:** For any events in the sample space, 
