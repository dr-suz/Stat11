...
date: "10/26/21 (updated: `r Sys.Date()`)"
output:
...
knitr::include_graphics("obie.jpg")
```
...
* Complete HW 5 by Friday, 6pm ET. 

* Submit you final project proposal on Moodle by Thursday. 

* HW 6 will be posted on Moodle tomorrow. Knit and read before class on Thursday. It will be due by 6pm on Friday, Nov 5th. 
