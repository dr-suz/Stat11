...
Note: There are actually a several valid ways to think about this problem. Any of the approaches above should be counted as correct. In any version, the correct answer is that we don't need any additional patients. Our data has more than enough observations to be able to estimate $p$ with this level of certainty and precision. 
