...
We will be using the 5th edition of [Stats: Data and Models](https://www.pearson.com/en-us/subject-catalog/p/stats-data-and-models/P200000006160/9780136880790).You are required to have access to Pearson's MyLab. You can purchase an 18 week access package through the campus bookstore.  The following details this package. 

STATS: DATA AND MODELS, LOOSE-LEAF EDITION PLUS MYLAB STATISTICS WITH PEARSON ETEXT -- 18 WEEK ACCESS CARD PACKAGE

ISBN: 9780135991206

BY DE VEAUX, RICHARD D., VELLEMAN, PAUL F., AND BOCK, DAVID E.

PUBLISHED BY PEARSON EDUCATION, Edition 5, PUBLICATION DATE: JUL. 31, 2019
...
A two-part workshop designed and led by our Stat clinicians will introduce students to R statistical computing.  Although geared toward students enrolled in Stat 11 or Stat 21, anyone with an interest in learning R is welcome to attend.  Each workshop will include instruction from 8-9 pm and an optional Q&A time from 9-10 pm.  

### Part 1

* Wednesday January 18 in SC 104 

* Thursday January 19 in SC 104

### Part 2

* Sunday January 22 in SC 105 

* Tuesday January 24 in SC 105
...
Over the semester, you will be assigned $5$ data-analysis homework problem sets that will each be graded for correctness. You are encouraged to work with one another one these homework assignments although each student must hand in their own copy of the solutions. You may use either Excel or RStudio to analyze the data in these assignments. We may occasionally use class time to work on some of these assignments. Your group homework grade will be the average of all $5$ assignments. No late group homework assignments will be accepted. 
...
The final exam will take place during the finals period <span style="color:red">(exact time/day TBD)</span> and it will be cumulative. The exam schedule will be posted by the registrar once it is determined. Do not schedule any travel plans during finals week as makeups will not be permitted  for the final exam. 
...
Stat 11 Clinics will be held on Sunday, Monday, and Tuesday nights in SC 105 from 7-10 pm and are exclusively for students enrolled in Stat 11.  These study sessions are a wonderful opportunity to study, do homework, meet and work with classmates, and ask questions about statistics.  Because study sessions are drop-in, you are welcome to come and go as you please.   Please write your name and course in the sign-in binder and the time you enter and leave the clinic so the Math/Stat Department has a record of your attendance.  To make the most of your time at study sessions, be sure to first try problems on your own, or bring questions you have from your text or lecture.  Having your textbook, lecture notes and online resources handy is essential because these are helpful resources for both you and the Clinician working with you.  There will likely be other students at study sessions with questions for the Clinicians, so do not expect to get individual attention the entire time you are there.  Be open to working on other problems, thinking about and trying to work through the question you have for the Clinicians, working with classmates, or doing other coursework while you wait to speak with the Clinician.  

|Stat 11 Clinic |SC 105 from 7-10pm |
|--------|------|
| Su | Anne French and Felicia Yi | 
| M | Quinn Basewitz and Joyce Ben |
| Tu | Lizbeth Zarate-Hernandez and Leia Donoway |

In addition to the course specific Clinics for Stat 11, you are welcome to attend the general Stat Clinic nights 7-10 pm on Sunday, Wednesday, and Thursday nights in SC 104.  Utilizing the general Stat Clinic is similar to making use of Stat 11 Clinic, but there may be students from different courses in attendance as well.  For questions about the Stat 11 Clinic and the general Stat Clinic please visit https://www.swarthmore.edu/mathematics-statistics/math-and-stat-clinic-study-sessions  or contact Laura Dandridge ldandri1@swarthmore.edu,  Academic Support Coordinator for the Math/Stat Department. Laura also has office hours to directly support students working on Stat 11  material, and you may sign up for an appointment on WASE.  

|General Stat Clinic |SC 104 from 7-10pm | 
|--- |--- |
| Atesh | Stat 11, 21, 51 |
| Alex | Stat 11, 23, 51, Math 39 |
| Ella | Stat 11, 21, 51, 111 |
