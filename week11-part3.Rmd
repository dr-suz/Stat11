...
date: "11/23/21 (updated: `r Sys.Date()`)"
output:
...
We're going to watch a $6$ minute video from The Amber Ruffin Show about AI and algorithmic bias. After watching the clip, you will have $7$ minutes to respond to the reflection prompt. 
...
### Final Project 
  ...
  - .blue[The last day of class] ~~you will have 5 minutes to present your final project to the class~~ .blue[will be an academic poster presentation session. You must bring your poster] ~~and assign a person to be the reporter/presenter~~ .blue[and each person should be ready to discuss your project with others.] ~~The remainder of the class time will be~~ .blue[You will have the entire class time to explore other peoples projects and ask questions about them. Each person will have a questionnaire to fill out about other people's projects and this will count towards your peer review component of your final project grade.]
...
* Test 2 
  ...
  - Test 2 corrections are due to be submitted online by Friday, Dec 3rd. 
...
* Read Ch 21 and 22 (5th edition) to help you complete HW 8 

* Homework

  - HW 8 will NOT be due over Thanksgiving break. It is due next Tuesday, Nov 30th by midnight. 

  - HW 9 will be graded entirely for completion and is worth $15$ HW points. Instructions will be posted by Monday, Nov 30th and it will be due on the following Monday, Dec 6. ]
