...
The second data set you will analyze for Problem 4 is the data you saw in the second week of class on the survival of different class passengers aboard the ship Titanic. This data consists of $2201$ passengers who either survived the wreck or died and their status as a passenger in first, second, or third class, or as a crew member of the ship. 

Problem 5 requires no data analysis.

The purpose of this assignment is to practice exploring categorical data, designing an experiment, and the laws of probability. 
...
Create a proportions table for the $84$ patients in this study and use it to answer the next two questions.
...
Create a contingency table (of counts) for the Titanic data. Then answer the following questions about this data.
...
(c.1) Find the mean and standard deviation of this distribution and (c.2) Suppose another random variable $Y$ is found by $Y = 3X - 2$. Use the rules for means (or expectations) and variances to find the mean and standard deviation of $Y$. 
