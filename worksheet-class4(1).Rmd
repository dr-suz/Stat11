...
```{r}
# data_mean <- global_wealth_and_health %>% select(LifeExpect) %>% ......
# data_mean
# data_var <- global_wealth_and_health %>% select(LifeExpect) %>% ......
# data_var
# data_sd <- global_wealth_and_health %>% select(LifeExpect) %>% ......
# data_sd
```
...
```{r}
# global_wealth_and_health %>% select(LifeExpect) %>% filter((LifeExpect<=data_mean+data_sd)&(LifeExpect>=data_mean-data_sd)) %>% length
# global_wealth_and_health %>% length
```
...
```{r}
# global_wealth_and_health %>% select(LifeExpect) %>% filter((LifeExpect<=?)&(LifeExpect>=?)) %>% length
```
