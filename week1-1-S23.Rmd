...
E.g. Age, time of day, birth order, etc. could all be either numeric or categorical depending on the discretion of the data analyst. 
...
* A job-seeker wants to quantify the turnover rate at his current place of employment to the turnover rates of other similar local paper suppliers in the north east. 

* Warehouse employees interested in forming a union want to quantify the risk associated with branch closure to see if it really is as close to $100\%$ as indicated by their company's CFO.
