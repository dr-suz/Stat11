...
date: "10/5/21 (updated: `r Sys.Date()`)"
output:
...
* Knit the HW 4 template and read over the questions 
...
* You will get your graded Test 1 back at the end of class. You may submit corrections for half-credit to my mailbox outside room SC 135 by 2pm this Friday. 



Final project  

* Proposals are due after break on Oct 21.   

* Very customizable! You'll have the opportunity to ask questions next class.  

* I will check my email on Monday and Friday over break and spend no more than 60 minutes on student emails. 


Announcement from the new Math/Stat Academic Coordinator: Laura Dangridge! 
