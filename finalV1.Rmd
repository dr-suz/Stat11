...
If $35\%$ of the students have never taken a statistics class, $25\%$ have taken only one semester of a statistics class, and the rest have taken two or more semesters of statistics, 

\vspace{1cm}
The probability that neither of the first two groupmates you meet has studied any statistics is $\rule{2cm}{0.15mm}$ .   
...
\vspace{1cm}
is approximately $\rule{2cm}{0.15mm}$ $cm$'s of snow.  


\vspace{2cm}
**26.** The ASQ (American Society for Quality) regularly conducts a salary survey of its membership, primarily quality management professionals. Based on the most recently published mean and standard deviation, a quality control specialist calculated the z-score associated with his own salary and found it was 2.50. 

\vspace{1cm}

This tells him that his salary is $\rule{2cm}{0.15mm}$ standard deviations $\rule{2cm}{0.15mm}$ the average salary. 
...
$\rule{3cm}{0.15mm}$ has the lowest median sales revenue.
...
the $\rule{3cm}{0.15mm}$ and $\rule{3cm}{0.15mm}$ will change but 

\vspace{1cm}

the $\rule{3cm}{0.15mm}$ will stay the same. 
...
$\rule{4cm}{0.15mm}$ and $\rule{4cm}{0.15mm}$. 
