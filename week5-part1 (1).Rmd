...
date: "9/28/21 (updated: `r Sys.Date()`)"
output:
...
---
## Prepare for the classes ahead 


Next class will be the first of two in-class exams/quizes. Come prepared to class by 
...
The first five minutes we will be setting up, then remaining $70$ minutes are for you to complete your answers. Content warning: the data you will examine on the test is relevant to current events and reflects information about the real world in which we live. Topics may include things such as the COVID pandemic and/or economic and social trends and patterns.  


Next week: 

* HW 4 will be released on Tuesday 

* Final project will be introduced on Tuesday 

* Read Chapters 12, 13, 14 in the 5th edition of your textbook 
